		...
		<div id="header_container">		
			...
			<!-- Header -->
				<div id="header" class="row">
					<div class="4u">
						<div class="wrapper">
							<h1><a href="index.html">CSS3<span class="header_colour">_business</span></a></h1>
				...
				<div class="row">
					...
					<section class="8u">						
						...
						<?php
							...
							$contact_submitted = 'Your message has been sent.  Now go check your email (dleung@connect.kellettschool.com) to see if it works.';
		...
		<div class="footer-wrapper">	
			...
			<!-- Footer -->
				<footer>
					...
					<p>Copyright &copy; CSS3_business | <a href="http://skeljs.org/">skel.js</a> | <a href="http://fotogrph.com/">Images</a> | <a href="http://www.css3templates.co.uk">design from css3templates.co.uk</a></p>
				</footer>		
			</div>
		</div>	
	</body>
